      ...
      return (
        <div className="max-w-4xl mx-auto animate-fade-in pb-20 md:pb-0">
          <Helmet>
            ...
            <link rel="canonical" href={`https://mapleads.online/blog/${selectedBlogPost.slug}`} />
                  ...
                  "itemListElement": [
                    {
                      ...
                      "position": 1,
                      "name": "Home",
                      "item": "https://mapleads.online/"
                    },
                    {
                      "@type": "ListItem",
                      "position": 2,
                      "name": "Blog",
                      "item": "https://mapleads.online/blog"
                    },
                    {
                      "@type": "ListItem",
                      "position": 3,
                      "name": selectedBlogPost.title,
                      "item": `https://mapleads.online/blog/${selectedBlogPost.slug}`,
                      "image": selectedBlogPost.imageUrl
                    }
                  ]
                }
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href={`https://twitter.com/intent/tweet?url=https://mapleads.online/blog/${selectedBlogPost.slug}&text=${encodeURIComponent(selectedBlogPost.title)}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-50 text-gray-500 flex items-center justify-center hover:bg-blue-400 hover:text-white transition-colors" title="Share on Twitter">
                    <Twitter size={14} />
                  </a>
                  <a href={`https://www.linkedin.com/shareArticle?mini=true&url=https://mapleads.online/blog/${selectedBlogPost.slug}&title=${encodeURIComponent(selectedBlogPost.title)}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-50 text-gray-500 flex items-center justify-center hover:bg-blue-700 hover:text-white transition-colors" title="Share on LinkedIn">
                    <Linkedin size={14} />
                  </a>
                  <a href={`https://www.facebook.com/sharer/sharer.php?u=https://mapleads.online/blog/${selectedBlogPost.slug}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-50 text-gray-500 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors" title="Share on Facebook">
                    <Facebook size={14} />
                  </a>
                  <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(selectedBlogPost.title + ' - https://mapleads.online/blog/' + selectedBlogPost.slug)}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-50 text-gray-500 flex items-center justify-center hover:bg-green-500 hover:text-white transition-colors" title="Share on WhatsApp">
                    <MessageCircle size={14} />
                  </a>
                  <button 
                    onClick={() => {
                      navigator.clipboard.writeText(`https://mapleads.online/blog/${selectedBlogPost.slug}`);
                      addToast("Link copied to clipboard!", "success");
                    }}
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a href={`https://www.linkedin.com/shareArticle?mini=true&url=https://mapleads.online/blog/${selectedBlogPost.slug}&title=${encodeURIComponent(selectedBlogPost.title)}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-50 text-blue-700 flex items-center justify-center hover:bg-blue-700 hover:text-white transition-colors shadow-sm hover:shadow-md" title="Share on LinkedIn">
                    <Linkedin size={18} />
                  </a>
                  <a href={`https://www.facebook.com/sharer/sharer.php?u=https://mapleads.online/blog/${selectedBlogPost.slug}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors shadow-sm hover:shadow-md" title="Share on Facebook">
                    <Facebook size={18} />
                  </a>
                  <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(selectedBlogPost.title + ' - https://mapleads.online/blog/' + selectedBlogPost.slug)}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-green-50 text-green-600 flex items-center justify-center hover:bg-green-500 hover:text-white transition-colors shadow-sm hover:shadow-md" title="Share on WhatsApp">
                    <MessageCircle size={18} />
                  </a>
                  <a href={`mailto:?subject=${encodeURIComponent(selectedBlogPost.title)}&body=${encodeURIComponent('Check out this article: https://mapleads.online/blog/' + selectedBlogPost.slug)}`} className="w-10 h-10 rounded-full bg-gray-50 text-gray-600 flex items-center justify-center hover:bg-gray-500 hover:text-white transition-colors shadow-sm hover:shadow-md" title="Share via Email">
                    <Mail size={18} />
                  </a>
                  <button 
                    onClick={() => {
    ...
    return (
      <div className="max-w-6xl mx-auto animate-fade-in pb-20 md:pb-0">
        <Helmet>
          ...
          <link rel="canonical" href="https://mapleads.online/blog" />
          <script type="application/ld+json">
            {JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Blog",
              ...
              "url": "https://mapleads.online/blog"
            })}
          </script>
        </Helmet>
  ...
  const renderPrivacy = () => (
    <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 animate-fade-in pb-20 md:pb-0">
      <Helmet>
        ...
        <link rel="canonical" href="https://mapleads.online/privacy" />
      </Helmet>
  ...
  const renderTerms = () => (
    <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 animate-fade-in pb-20 md:pb-0">
      <Helmet>
        ...
        <link rel="canonical" href="https://mapleads.online/terms" />
      </Helmet>
  ...
  const renderContact = () => (
    <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 animate-fade-in pb-20 md:pb-0">
      <Helmet>
        ...
        <link rel="canonical" href="https://mapleads.online/contact" />
      </Helmet>
  ...
  const renderAbout = () => (
    <div className="max-w-4xl mx-auto space-y-12 animate-fade-in pb-20 md:pb-0">
      <Helmet>
        ...
        <link rel="canonical" href="https://mapleads.online/about" />
      </Helmet>
